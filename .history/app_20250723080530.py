                ...
                if parent:
                    ...
                    if staff_name:
                        staff_list.append({
                            ...
                            '画像URL': img.get('src', ''),
                            '詳細': parent.get_text().strip()[:100] + '...' if len(parent.get_text().strip()) > 100 else parent.get_text().strip()
                        })
        else:
                ...
                for item in staff_items:
                    ...
                    if name_elem:
                        staff_info = {
                            ...
                            '詳細': item.get_text().strip()[:100] + '...' if len(item.get_text().strip()) > 100 else item.get_text().strip()
                        }
